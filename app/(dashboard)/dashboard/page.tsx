...
import { PlusCircle, FileText, Clock, CheckCircle, AlertCircle, TrendingUp, BarChart3, Brain } from 'lucide-react'
    ...
    <div className="p-8">
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-slate-500 text-sm mt-1">Central de análise operacional multimodal</p>
        </div>
      ...
      <div>
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-lg font-semibold text-slate-800">Análises recentes</h2>
          {analyses.length > 5 && (
